...
namespace AppLib.Editor
{
    /// <summary>
    /// 新規スクリプト生成時にテキストエンコードをUTF-8に変換する
    /// referenced from https://github.com/sharkattack51/GarageKit_for_Unity/blob/master/UnityProject/Assets/__ProjectName__/Editor/AssetPostprocessUTF8Encode.cs
    /// </summary>
    public class AssetPostprocessUTF8Encode : AssetPostprocessor
    {
        /// <summary>
        /// csファイルをBOM付きUTF8に変える
        /// </summary>
        /// <param name="importedAssets"></param>
        /// <param name="deletedAssets"></param>
        /// <param name="movedAssets"></param>
        /// <param name="movedFromAssetsPath"></param>
